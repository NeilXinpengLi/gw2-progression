...
ENDPOINT_SCHEMAS: list[EndpointDef] = [
    ...
    EndpointDef(
        ...
        method="GET",
        permissions={"account"},
        required_fields=["id", "name", "age", "world", "created"],
        relations=["owns_character", "owns_guild"],
        ttl_seconds=1800,
    ),
    EndpointDef(
        name="characters",
        ...
        required_fields=["name", "profession", "level", "race"],
        relations=["equips_item", "has_skill", "has_trait"],
        ttl_seconds=1800,
    ),
    ...
    EndpointDef(
        ...
        required_fields=["id", "count", "category"],
        relations=["contains_material"],
        ttl_seconds=1800,
    ),
    ...
    EndpointDef(
        ...
        required_fields=["id", "current", "done"],
        relations=["tracks_achievement"],
        ttl_seconds=1800,
    ),
    ...
    EndpointDef(
        ...
        relations=["has_type", "has_rarity", "requires_item"],
        ttl_seconds=259200,
    ),
    EndpointDef(
        name="recipes",
        ...
        relations=["produces_item", "consumes_item", "requires_discipline"],
        ttl_seconds=259200,
    ),
    ...
    EndpointDef(
        ...
        method="GET",
        is_public=True,
        required_fields=["id", "name", "type", "professions"],
        relations=["teaches_skill", "requires_skill"],
        ttl_seconds=259200,
    ),
]
